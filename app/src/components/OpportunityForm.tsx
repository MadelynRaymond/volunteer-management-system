...
import { Box, Button, Flex, FormControl, FormLabel, Input, Select, Stack, Textarea } from '@chakra-ui/react'
...
export default function OpportunityForm() {
  ...
  const submit = () => {
    ...
    const hasErrors = [name, center, address, desc, startTime, endTime].some(field => field === '')
      ...
      <Box w="700px">
        <Stack spacing='1.25rem'>
            ...
            <Flex gap='5' justifyContent='center'>
             ...
             <Button onClick={submit} colorScheme='pink' leftIcon={<CheckIcon />}  variant='solid'>
                Submit
              </Button>
            </Flex>
        </Stack>
