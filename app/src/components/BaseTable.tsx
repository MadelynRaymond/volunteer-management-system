...
export default function BaseTable() {
  return (
    <TableContainer shadow={'md'} textAlign={'center'} borderRadius={'0.5rem'} p={2}>
            <Table variant='simple' colorScheme='facebook'>
              ...
              <Tbody>
                ...
                <Tr>
                  ...
                  <Td>
                    <Tag variant={'solid'} colorScheme={'green'}>Approved</Tag>
                  </Td>
                </Tr>
                ...
                <Tr>
                  ...
                  <Td>
                    <Tag variant={'solid'} colorScheme={'yellow'}>Pending</Tag>
                  </Td>
                </Tr>
                ...
                <Tr>
                  ...
                  <Td>
                    <Tag variant={'solid'} colorScheme={'red'}>Denied</Tag>
                  </Td>
                </Tr>
              </Tbody>
            </Table>
